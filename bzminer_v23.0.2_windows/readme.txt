************************************
*                                  *
*  BzMiner v22.0 Readme            *
*                                  *
************************************

ethw (EthPOW, 0.5% dev fee)
etchash (Ethereum Classic, 0.5% dev fee)
rvn (Ravencoin, 1.0% dev fee)
meowcoin (Meowcoin, 1.0% dev fee)
neoxa (Neoxa, 1.0% dev fee)
clore (Clore, 1.0% dev fee)
xna (Neurai, 1.0% dev fee)
olhash (Overline, 1% dev fee)
alph (Alephium, 0.5% dev fee)
kaspa (Kaspa, 1% dev fee)
ixi (Ixian, 1% dev fee)
zil (Zilliqa, 0% dev fee)
ergo (Ergo, 1.0% dev fee)
radiant (RDX, 1.0% dev fee)
nexa (Nexa, 2.0% dev fee)
ironfish (Ironfish, 1.0% dev fee)
octa (OctaSpace, 0.5% dev fee)
novo (Novo, 1.0% dev fee)
kylacoin (Kylacoin, 1.0% dev fee)
gamepass (Gamepass, 1.0% dev fee)
canxium (Canxium, 0.5% dev fee)
decred (Decred, 1.0% dev fee)
dynex (Dynex, 2.0% dev fee)
karlsen (Karlsen, 1.0% dev fee)
nexellia (nexellia, 1.0% dev fee)
dint (DinarTether, 1.0% dev fee)
larissa (larissa, 0.5% dev fee)
warthog (warthog, 2.0% dev fee)
aidepin (aidepin, 1.0% dev fee)
aipg (aipg, 1.0% dev fee)
blocx (Blocx, 1.0% dev fee)
